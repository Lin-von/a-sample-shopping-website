...
<head>
    ...
    <script>
        ...
        function pwdcheck() {
            ...
            xmlhttp.open("GET","pwdcheck1.php?q="+str+"&name=<?php echo $name?>",true);
            xmlhttp.send();
        }
    </script>
    <!-- //FlexSlider-->
...
<div class="reg-form">
    ...
    <div class="abc" style="float: left;position:relative;left: 40%;">
        <p style="font-family: 黑体;font-size: 2em;">购物车结算 </p>
        <br><br>
        <p style="font-family: 黑体;font-size: 1.5em;">  总额：<?php echo $price;?></p>
    </div>
</div>
<div style="position: relative;top: 150px;" class="reg-form">
    <p style="position:relative;left: 40%;font-family: 黑体;font-size: 1em;"> 请输入密码确认支付</p>
    <input id="passw" style="position:relative;left: 40%" type="password">
    <button style="position:relative;left: 40%;" onclick="pwdcheck()">确认支付</button>
</div>
