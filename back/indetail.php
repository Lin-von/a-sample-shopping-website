...
<div  id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="charts"><a href="outmang.php" title=""><span>入库管理</span></a></li>
...
<div style="height: auto;" id="rightSide">
    ...
    $sql = "SELECT item_10312.*,in_detail_10312.* FROM in_detail_10312 JOIN item_10312 on in_detail_10312.gid=item_10312.gid WHERE in_detail_10312.inid=$inid ";
