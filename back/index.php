...
<head>
    <?php session_start();
     if($_SESSION['level']==6 ) header( "Location: index2.php" );
     else if($_SESSION['level']==7 )header( "Location: index1.php" );
...
<div style="height: 800px;" id="rightSide">
    ...
    <!-- Main content wrapper -->
        ...
        <!-- Widgets -->
                ...
                <img style="height:40%;width:40%;position: relative;left: 490px; top: 100px;" src="images/logo.png" alt="" />
                <b style="font-family: 黑体;font-size: 3em;position: relative; top:160px;">欢迎访问网上商城</b>
                <!-- New users widget -->
