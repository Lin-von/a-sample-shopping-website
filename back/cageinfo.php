...
<div  id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="ui"><a href="cageinfo.php" title="" class="active"><span>库存信息</span></a></li>
        ...
        <div class="wrapper">
            ...
            <div class="userNav">
                <ul>
                    ...
                    <li><a href="../back/index2.php" title=""><img src="images/icons/topnav/settings.png" alt="" /><span>仓库管理</span></a></li>
                        ...
                        <div style="position: relative; left:30%;width: 1000px;" class="widget">
                            ...
                            <div class="newOrder">
                                <div class="userRow">
                                    ...
                                    <ul class="rightList">
                                        <li><a href="#" title=""> <strong>已入库</strong></a></li>
                                ...
                                <div class="orderRow">
                                    ...
                                    <ul class="rightList">
                                        ...
                                        <li><strong class="orange"><?php echo $row["remain"];?></strong></li>
                                    </ul>
                                    <div class="clear"></div>
                                </div>
