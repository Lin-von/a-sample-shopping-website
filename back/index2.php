...
<?php session_start();?>
    ...
    <div class="statsRow">
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
                    <li><a href="inmang.php" title=""><img src="images/icons/control/32/database.png" alt="" /><span>入库管理</span></a></li>
                    <li><a href="outmang.php" title=""><img src="images/icons/control/32/statistics.png" alt="" /><span>出库管理</span></a></li>
                    <li><a href="inout.php" title=""><img src="images/icons/control/32/order-149.png" alt="" /><span>盘营盘亏</span></a></li>
                    <li><a href="cageinfo.php" title=""><img src="images/icons/control/32/comment.png" alt="" /><span>库存信息</span></a></li>
    ...
    <img style="height:30%;width:30%;position: relative;left: 600px; top: 100px;" src="images/logo.png" alt="" />
    <b style="font-family: 黑体;font-size: 3em;position: relative; left: 200px; top:160px;">欢迎进入仓库管理</b>
