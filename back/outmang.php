...
<div style="height: auto;" id="rightSide">
    ...
    <div class="wrapper">
                        ...
                        <div class="widget">
                            ...
                            <div class="newOrder">
                                <div class="userRow">
                                    ...
                                    <ul class="leftList">
                                        <li><a href="#" title=""><strong>出向：<?php echo $row['whoto'];?></strong></a></li>

                                    </ul>
                                    <ul class="rightList">
                                        <li><a href="outdetail.php?outid=<?php echo $row['outid'];?>" title=""><strong>查看详情</strong></a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="delete2.php?outid=<?php echo $row['outid'];?>&way=out" title=""> <strong>删除记录</strong></a></li>
                                        <li class="orderIcons"><span class="oUnfinished"></span><span class="oShipped tipN" title="Shipped on Feb 2nd, 2012"></span>已出库</li>
                                    </ul>
                                    <div class="clear"></div>
                                </div>
        ...
        <div class="oneTwo">
            <form id="usualValidate" class="form" method="post" action="outcage.php?count=<?php echo $count;?>"">
                <fieldset>
                    <div class="widget">
                        <div class="title"><img src="images/icons/dark/alert.png" alt="" class="titleIcon" /><h6>添加出库信息</h6></div>
                        <?php  for($i=1;$i<=$count;$i++) {?>
                        <div class="formRow dnone">
                            <label style="width: 10%;">出库信息:</label>
                        ...
                        <div style="float: left" class="formSubmit"><a href="outmang.php?count=<?php echo $count+1;?>" ><input type="button" value="添加一条信息" class="blueB" /></a></div>
                        <div style="float: left" class="formSubmit"><input type="text" name="whoto" placeholder="出向" /></div>
