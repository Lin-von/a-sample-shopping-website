...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="files"><a href="purchaser.php" title="" class="active"><span>我购买的商品</span></a></li>
        <li class="typo"><a href="accm.php" title="" ><span>账户管理</span></a>
...
<div id="rightSide">
    ...
    <div class="titleArea">
        <div class="wrapper">
            ...
            <div class="middleNav">
                <ul>
                    <li class="mUser"><a title="账户管理" class="tipN"><span class="users"></span></a>

                    </li>
                    <li class="mFiles"><a href="updatelv.php" title="更新会员等级" class="tipN"><span class="files"></span></a></li>
                    <li class="mOrders"><a title="余额管理" class="tipN"><span class="orders"></span></a>
    ...
    <div class="wrapper">
        ...
        $sql = "SELECT item_10312.*,buyrcd_10312.* FROM buyrcd_10312 join item_10312 on item_10312.gid=buyrcd_10312.gid WHERE buyrcd_10312.uname = '$uname' ORDER BY buyrcd_10312.date desc";
                ...
                <div style="position: relative; left:30%;width: 1000px;" class="widget">
                    ...
                    <div class="newOrder">
                        <div class="userRow">
                            ...
                            <ul class="rightList">
                                <li><a href="#" title=""> <strong>已发货</strong></a></li>
                        ...
                        <div class="cLine"></div>
                        <div class="totalAmount"><h6 class="floatL blue">支付金额:</h6><h6 class="floatR blue"><?php echo $row["cost"];?></h6><div class="clear"></div></div>
                    </div>
                </div>
